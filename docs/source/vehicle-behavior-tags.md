...
| Keep-speed | Maintaining a constant speed without acceleration or deceleration |
...
| Honk | Using the vehicle horn to alert or communicate with pedestrians or other road users |
| Right-turn | Making a right turn, which may affect pedestrian crossing paths |
| Left-turn | Making a left turn, which may affect pedestrian crossing paths |
| **Collision**| |
